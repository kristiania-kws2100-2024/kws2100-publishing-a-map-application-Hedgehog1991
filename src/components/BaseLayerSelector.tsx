...
export function BaseLayerSelector() {
    const { setBaseLayer } = useContext(BaseMap);
    ...
    const options = {
            ...
            stadia: {
                name: "Stadia",
                layer: new TileLayer({
                    source: new StadiaMaps({ layer: "outdoors", apiKey:"69dfeec6-dedf-4d6d-8344-154bbd2724d9" }) }),
            },
            dark: {
                name: "Stadia (dark)",
                layer: new TileLayer({
                    source: new StadiaMaps({ layer: "alidade_smooth_dark", apiKey:"69dfeec6-dedf-4d6d-8344-154bbd2724d9" }),
                }),
            },
            kartverket: {
                name: "Kartverket",
